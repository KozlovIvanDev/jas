(function (window, undefined){
	...
	AcceptCookie.prototype = {
		...
		addCookieBar: function(){
			...
			htmlBar += '<p>Ми використовуємо файли cookie, щоб забезпечити найкращий доступ до роботи на нашому веб-сайті. <br />Закриваючи це повідомлення, ви погоджуєтесь з нашими файлами cookie на цьому пристрої відповідно до нашої політики щодо файлів cookie, якщо ви їх не відключили.</p>';
			htmlBar += '<div class="pjAcceptCookieBarActions">';
			htmlBar += '<button type="button" class="pjAcceptCookieBarBtn">Я згоден!</button>';
			htmlBar += '</div>';
			htmlBar += '</form>';
			htmlBar += '</div>';
